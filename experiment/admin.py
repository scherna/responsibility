...
class BlockAdmin(admin.ModelAdmin):
    fieldsets = [
        ...
        (None,{'fields':['v_na']}),
        ('Display Parameters' ,{'fields':[('stimulus', 'num_dec_places'),('alert_signal_color','alert_noise_color'),('display_last_points', 'display_outcome', 'display_total_points','display_trial_num')]}),
        ('Timing Parameters', {'fields':[('stimulus_duration','stimulus_delay'),('alert_duration','alert_delay'),('trial_duration','trial_delay')]}),
    ]
    class Media:
        css = {
